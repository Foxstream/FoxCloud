...
interface SettingsUsersScope {
  ...
  // /**
  //  * The set of currently-selected users.
  //  */
  // selectedUsers: User[];
  //
  // /**
  //  * A dictionary from a userId to a user.
  //  * The users in this dictionary are selected.
  //  */
  // selectedElts: {[userId: string]: {selected: boolean, user: User}};
  //
  // /**
  ...
  //
  // /**
  //  * If `false`: editing an existing user.
  //  * If `true`: creating a new user.
  //  */
  // isNewUser: boolean;
  //
  // /**
  //  * If `false`: display the list of users (`ListMode`).
  //  * If `true`: display the edition form.
  //  */
  // isEditionMode: boolean;
  //
  // /**
  //  * Toggle the selection of all the users.
  //  */
  // toggleAll(): void;
  //
  // /**
  //  * Toggle the selection of the user with the corresponding ID.
  //  * If no user is found for the corresponding ID, silently fail.
  //  */
  // toggleOne(userId: UserId): void;
  //
  // /**
  //  * Open the edition page, instead of the user list.
  //  */
  // switchToEditionMode(): void;
  //
  // /**
  //  * Open the user list, instead of the edition page.
  //  */
  ...
  //
  // /**
  //  * Open the edition page for the supplied user.
  //  */
  ...
  //
  // /**
  //  * Delete the currently selected users.
  //  */
